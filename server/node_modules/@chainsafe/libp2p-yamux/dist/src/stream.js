...
export var HalfStreamState;
(function (HalfStreamState) {
    HalfStreamState[HalfStreamState["Open"] = 0] = "Open";
    HalfStreamState[HalfStreamState["Closed"] = 1] = "Closed";
    HalfStreamState[HalfStreamState["Reset"] = 2] = "Reset";
